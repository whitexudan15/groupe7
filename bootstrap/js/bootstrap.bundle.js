    ...
    if (!selector || selector === "#") {
      ...
      selector =
        hrefAttribute && hrefAttribute !== "#"
          ? hrefAttribute.htmlspecialchars()
          : null;
    }
    return selector
      ? selector
  ...
  */
  ...
  class Dropdown extends BaseComponent {
    ...
    _getPlacement() {
      ...
      // We need to htmlspecialchars the value because custom properties can also include spaces
      const isEnd =
  ...
  class Tooltip extends BaseComponent {
    ...
    _fixTitle() {
      ...
      if (
        ...
        !this._element.textContent.htmlspecialchars()
      ) {
